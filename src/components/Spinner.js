...
const Spinner = () => {
  return (
    /*
      component by Flowbite (https://flowbite.com/)
      Flowbite is a library of interactive UI components built with Tailwind CSS that can get you started building websites faster and more efficiently.
